...
extension RepositoryExtension on Repository {
  RepositoryScope _getScope<E extends Entity>([E? entity]) {
    ...
    RepositoryScope? repositoryScope = this.containsScope<E>();
    if (repositoryScope == null && entity != null) {
      repositoryScope = this.create<E>(entity, (_) {});
    }
  ...
  E getEntity<E extends Entity>([E? entity]) {
    RepositoryScope repositoryScope = this._getScope<E>(entity);
    return this.get<E>(repositoryScope);
  }
  ...
  void updateEntity<E extends Entity>(E entity) {
    RepositoryScope repositoryScope = this._getScope(entity);
    this.update<E>(repositoryScope, entity);
  }
  ...
  Future<void> runService<E extends Entity>(
    ...
    await this.runServiceAdapter(repositoryScope, serviceAdapter);
  }
}
